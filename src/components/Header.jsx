...
function Header() {
  return (
    <motion.nav className="flex items-center justify-between mb-5 py-2">
      ...
      className="flex flex-shrink-0 items-center text-5xl font-mono text-neutral-950 selection:bg-slate-600 selection:text-white">Payment <span className="font-bold">Portal</span>
